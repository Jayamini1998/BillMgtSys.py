...
def Reset():
    ...
    Total_bill.set("")  # Clear the total bill as well
...
def Total():
    ...
    string_bill = "Rs. {:.2f}".format(totalcost)
...
Label(f, font=("Lucida Calligraphy", 12, 'bold'), text="Dosa..........Rs.60/plate", fg="black", bg="lightgreen").place(x=10, y=80)
Label(f, font=("Lucida Calligraphy", 12, 'bold'), text="Cookies..........Rs.30/plate", fg="black", bg="lightgreen").place(x=10, y=110)
Label(f, font=("Lucida Calligraphy", 12, 'bold'), text="Tea..........Rs.7/cup", fg="black", bg="lightgreen").place(x=10, y=140)
Label(f, font=("Lucida Calligraphy", 12, 'bold'), text="Coffee..........Rs.100/cup", fg="black", bg="lightgreen").place(x=10, y=170)
Label(f, font=("Lucida Calligraphy", 12, 'bold'), text="Juice..........Rs.20/glass", fg="black", bg="lightgreen").place(x=10, y=200)
Label(f, font=("Lucida Calligraphy", 12, 'bold'), text="Pancakes..........Rs.15/plate", fg="black", bg="lightgreen").place(x=10, y=230)
Label(f, font=("Lucida Calligraphy", 12, 'bold'), text="Eggs..........Rs.7/egg", fg="black", bg="lightgreen").place(x=10, y=260)
